...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'tropicana' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'tropicana' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'tropicana' ),
		'cyrillic'     => __( 'Cyrillic', 'tropicana' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'tropicana' ),
		'devanagari'   => __( 'Devanagari', 'tropicana' ),
		'greek'        => __( 'Greek', 'tropicana' ),
		'greek-ext'    => __( 'Greek Extended', 'tropicana' ),
		'khmer'        => __( 'Khmer', 'tropicana' ),
		'latin'        => __( 'Latin', 'tropicana' ),
		'latin-ext'    => __( 'Latin Extended', 'tropicana' ),
		'vietnamese'   => __( 'Vietnamese', 'tropicana' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'tropicana' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'tropicana' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'tropicana' ),
