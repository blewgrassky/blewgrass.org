...
function blocksy_output_responsive($args = []) {
	...
	$args['mobile_css']->put(
		$args['selector'],
		'--' . $args['variableName'] . ': ' . $value['mobile'] . $args['unit']
	);
	$args['tablet_css']->put(
		$args['selector'],
		'--' . $args['variableName'] . ': ' . $value['tablet'] . $args['unit']
	);
	$args['css']->put(
		$args['selector'],
		'--' . $args['variableName'] . ': ' . $value['desktop'] . $args['unit']
	);
}
...
function blocksy_output_border($args = []) {
	...
	$value = blocksy_expand_responsive_value(
		$args['value'],
		$args['responsive']
	);
